# Description: Demonstrate how to run a Selenium test with BrowserStack.
# Run: ruby bstackdemo.rb
...
begin
  ...
  # Check if the 'Favorites' section is displayed
  favorites = driver.find_element(:xpath, '//*[@id="11"]')
  if favorites.displayed? == false
    logger.error 'Favorites not displayed'
    raise 'Favorites not displayed'
  end
